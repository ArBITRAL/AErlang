...
start() ->
    ...
    aman:init(#{id=> m2, sex => man, wealth => rich, body => weak, predicate => ["eyes = this.feyes and hair = this.fhair", "eyes = this.feyes", "hair = this.fhair", "sex = woman"],feyes => green, fhair => dark, refusal => [] , partner => -1}),
    aman:init(#{id=> m3, sex => man, wealth => poor, body => strong,predicate => ["eyes = this.feyes and hair = this.fhair", "eyes = this.feyes", "hair = this.fhair", "sex = woman"], feyes => green, fhair => red, refusal => [], partner => -1}),
