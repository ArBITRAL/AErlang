...
get_index(aerl_time,pid)-> '$1';
get_index(aerl_time,timestamp)-> '$2';
get_index(aerl_time,pred)-> '$3';
get_index(aerl_time,F) -> exit({error,"Record: aerl_time has no field called "++atom_to_list(F)});
