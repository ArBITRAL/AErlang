...
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, 7, Tlen);
yystate(33, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 101 ->
    yystate(10, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(32, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(30, Ics, Line, Tlen+1, 7, Tlen);
yystate(32, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 64 ->
    yystate(14, Ics, Line, Tlen+1, 7, Tlen);
yystate(32, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(30, Ics, Line, Tlen+1, 7, Tlen);
yystate(32, [C|Ics], Line, Tlen, _, _) when C >= 91, C =< 94 ->
    yystate(14, Ics, Line, Tlen+1, 7, Tlen);
yystate(32, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 122 ->
    yystate(30, Ics, Line, Tlen+1, 7, Tlen);
yystate(32, [C|Ics], Line, Tlen, _, _) when C >= 123 ->
    yystate(14, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 101 ->
    yystate(10, Ics, Line, Tlen+1, 4, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 106, C =< 109 ->
    yystate(10, Ics, Line, Tlen+1, 4, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 112, C =< 115 ->
    yystate(10, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(10, Ics, Line, Tlen+1, 7, Tlen);
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 113 ->
    yystate(10, Ics, Line, Tlen+1, 7, Tlen);
